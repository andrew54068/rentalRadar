...
class Preference:
    ...
    def sql_insert_field_string(self):
        ...
        self.space != None and result_list.append("space")
    ...
    def sql_insert_value_string(self):
        ...
        self.space != None and result_list.append(f"'{self.space}'")
        return ",".join(result_list)
    ...
    def on_duplicate_key_update_string(self):
        ...
        self.space != None and result_list.append(f"space=VALUES(space)")
        return ",".join(result_list)
